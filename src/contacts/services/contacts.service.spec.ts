...
describe('ContactsService', () => {
  ...
  it('should update a contact', async () => {
    ...
    const  UpdateResult = await service.update(contactToUpdate.id,contactToUpdate);
    expect(UpdateResult).toEqual(contactToUpdate);
    expect(repositoryMock.update).toHaveBeenCalledWith(contactToUpdate.id, contactToUpdate);
  });
  ...
  it('should fail to update a contact', async () => {
    ...
    repositoryMock.findOne.mockReturnValue(null);
    await expect(service.update(contactToUpdate.id, contactToUpdate)).rejects.toThrow(NotFoundException);
